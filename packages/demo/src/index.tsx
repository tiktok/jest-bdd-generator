...
const Demo: React.FC<{
  ...
  React.useEffect(() => {
    fetch(feature)
      .then((res) => res.text())
      .then((ret) => setFeatSource(ret));
  }, [feature]);

  React.useEffect(() => {
    fetch(testing)
      .then((res) => res.text())
      .then((ret) => setTestSource(ret));
  }, [testing]);
...
const routes: RouteObject[] = [
  ...
  },
  {
    ...
    element: (
      <Demo
        Child={TestGeneration}
        feature="/docs/features/successfulMathRound.feature"
        testing="/tests/noImplement.test.ts"
      />
    )
  },
  {
    ...
    element: (
      <Demo
        Child={TestGeneration}
        feature="/docs/features/successfulMathRound.feature"
        testing="/tests/noComment.test.ts"
      />
    )
  },
  {

...
export const TestGeneration: React.FC = () => {
  ...
  const [gherkinSource, setGherkinSource] = useState<string>('');
  const [jestSource, setJestSource] = useState<string>('');
  ...
  return (
    <>
      <LineWrapper>
        <SourceCodeEditor updateHandler={setJestSource} type="typescript" />
        <SourceCodeEditor updateHandler={setGherkinSource} type="markdown" />
      </LineWrapper>
